...
func TestHostWiring(t *testing.T) {
	...
	if want := "imf://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("imf", "about")
	if err != nil || got.String() != "imf://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want imf://page/about", got.String(), err)
	}
}
