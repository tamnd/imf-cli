---
title: "imf"
description: "A command line for imf."
heroTitle: "imf, from the command line"
heroLead: "A command line for imf. One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
imf links <path>           # the pages it links to, each addressable
imf serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading imf by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address imf as
  `imf://` URIs and follow links across sites. See
