...
Most of these come down to network reality or how imf serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

imf rate-limits like any public site. imf already paces
...
Where a surface is gated, imf reads a cookie or token you supply
...
`imf`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what imf actually did
